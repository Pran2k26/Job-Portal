...
const JobDescription = () => {
  ...
  const applyJobHandler = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        dispatch(setSingleJob(updateSingleJob)); // help to update the ui
  ...
  useEffect(() => {
    const fetchSingleJob = async () => {
      try {
        console.log("fetching the job with the id", jobId)//just to check 
  ...
  return (
    <div className="max-w-7xl mx-automy-10">
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">
          Posted Date:<span className="pl-4 font-normal text-gray-800">19-06-2025</span>
        </h1>
      </div>
    </div>
  );
